...
This document addresses privacy and confidentiality considerations when using this Tool, with particular attention to professional obligations under Malaysian bar association rules and the Personal Data Protection Act 2010 (PDPA).
...
- Malaysian Bar Council (Majlis Peguam Malaysia) rules require strict confidentiality of client information under the Legal Profession Act 1976

**Safe Use Options:**
1. **General Legal Research**: Use Tool for non-client-specific queries
2. **Local npm Package**: Install `@ansvar/malaysian-law-mcp` locally — database queries stay on your machine
...
## Professional Obligations (Malaysia)

### Malaysian Bar Council Rules

Malaysian lawyers (advocates and solicitors) are bound by strict confidentiality rules under the Legal Profession Act 1976, the Legal Profession (Practice and Etiquette) Rules 1978, and Bar Council Rulings.

#### Legal Professional Privilege

- All client communications are privileged under the Evidence Act 1950 (Sections 126-129)
...
- Breach of privilege may lead to disciplinary proceedings by the Bar Council

### PDPA and Client Data Processing

Under the **Personal Data Protection Act 2010 (PDPA)** as administered by JPDP:

- You are the **Data User** (equivalent to data controller)
- AI service providers (Anthropic, Vercel) may be **Data Processors**
- The PDPA requires compliance with seven data protection principles
- Cross-border data transfers require compliance with Section 129 PDPA
- Ensure adequate security measures under the Security Principle
...
```
Example: "What does the Malaysian Employment Act 1955 say about termination notice periods?"
```
...
```
Example: "What are the penalties for money laundering under AMLA 2001?"
```
...
3. Client matters: Use commercial legal databases (CLJ, MLJ, LexisNexis Malaysia)
...
4. Ensure compliance with PDPA cross-border transfer requirements

### For Government / Public Sector

1. Use self-hosted deployment, no external APIs
2. Follow Malaysian government ICT security requirements (MyRAM, RAKKSSA)
...
- **Privacy Questions**: Open issue on [GitHub](https://github.com/Ansvar-Systems/malaysian-law-mcp/issues)
- **Anthropic Privacy**: Contact privacy@anthropic.com
- **Malaysian Bar Guidance**: Consult the Malaysian Bar Council Ethics Committee
